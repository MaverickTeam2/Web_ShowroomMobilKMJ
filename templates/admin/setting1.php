<?php
// Contoh ambil data user dari database atau session
$user = [
  "nama" => "Herdi",
...
<body>
  ...
  <div class="head-title">
    ...
    <a href="#" class="btn-download btn btn-primary">
          ...
          <div class="mb-4">
            ...
            <div class="d-flex align-items-center gap-3">
              ...
              <div>
                ...
                <p class="text-muted mt-2 mb-0" style="font-size: 0.9rem;">Upload logo Showroom anda (disarankan:
                  150×150px)</p>
              </div>
            </div>
          </div>
