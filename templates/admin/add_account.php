...
<head>
    ...
    <title>Tambah Akun - Kaliwates Mobil Jember</title>
        ...
        <main class="flex-1 ml-56">
            <div class="px-10 pt-6 pb-8">
                <div class="flex justify-between items-start mb-8">
                    <div>
                        <h2 class="text-4xl font-bold text-gray-900 mb-1.5">Tambah Akun</h2>
                        <p class="text-gray-600 text-base">Tambahkan akun baru untuk admin</p>
                    </div>
                        ...
                        <div class="flex justify-center mb-16">
                            <label for="photo" class="cursor-pointer">
                                <div id="photoPreview" class="w-52 h-52 rounded-full border-2 border-dashed border-gray-300 flex flex-col items-center justify-center bg-white hover:bg-gray-50 transition-colors overflow-hidden">
                                    ...
                                    <p class="text-gray-400 text-base">Add Photo</p>
                                </div>
