...
$recent_activity = [
    ["judul" => "Mobil ditambahkan", "deskripsi" => "Mobil BMW ATX R8 ditambahkan ke inventory", "waktu" => "7 menit yang lalu"],
    ["judul" => "Transaksi baru", "deskripsi" => "Pelanggan membeli mobil Avanza 2024", "waktu" => "12 menit yang lalu"],
    ["judul" => "Mobil dihapus", "deskripsi" => "Mobil Honda Civic dihapus dari data lama", "waktu" => "1 jam yang lalu"],
    ["judul" => "Mobil reserved", "deskripsi" => "Mobil Pajero Sport telah dipesan pelanggan", "waktu" => "2 jam yang lalu"],
    ["judul" => "Transaksi selesai", "deskripsi" => "Penjualan Toyota Rush berhasil diselesaikan", "waktu" => "3 jam yang lalu"]
];
...
<section id="content">
  ...
  <main class="p-4">
    ...
    <div class="btn-group mb-4">
      <button class="btn btn-blue" data-page="add_car.php"><i class="bx bx-plus"></i> Tambah mobil</button>
      <button class="btn btn-green" data-page="add_transaction.php"><i class="bx bx-dollar"></i> Transaksi baru</button>
        ...
        <div class="table-responsive">
          <table class="table align-middle">
            <tbody>
              ...
              <tr>
                <td>
                  <img src="../../assets/img/ic_recentacitivty.jpg" alt="activity" style="width:40px;border-radius:50%;">
                  <div class="d-inline-block ms-2">
                    <p class="mb-0 fw-semibold"><?= $r['judul'] ?></p>
