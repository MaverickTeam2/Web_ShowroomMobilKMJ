...
-->
  <section class="section compare-section" data-car1="<?php echo htmlspecialchars($car1Code); ?>"
    ...
    <div class="container is-fluid">
          ...
          <div class="compare-info-row">
            <div class="compare-info-col" data-car="1">
              ...
              <div class="compare-info-actions">
                <button class="btn-compare-primary btn-reservasi" data-car="1">Reservasi</button>
                <button class="btn-compare-outline btn-detail" data-car="1">Lihat detail</button>
              </div>
            </div>
            ...
            <div class="compare-info-col" data-car="2">
              ...
              <div class="compare-info-actions">
                <button class="btn-compare-primary btn-reservasi" data-car="2">Reservasi</button>
                <button class="btn-compare-outline btn-detail" data-car="2">Lihat detail</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="compare-photo-row">
        <div class="compare-photo-col">
          <img id="car1-photo" src="" <!-- nanti diisi dari API lewat JS -->
        </div>
        <div class="compare-photo-col">
          <img id="car2-photo" src="" <!-- nanti diisi dari API lewat JS -->
        </div>
      </div>
