...
<body>
  ...
  <section class="section">
    <div class="container">
      <div class="columns is-vcentered">
        ...
        <div class="column is-5">
          <h1 class="title">Pusat Bantuan & FAQ KMJ</h1>
        </div>
    ...
    <div class="faq-contact">
      ...
      <div class="columns">
        ...
        <div class="column is-one-quarter">
          <div class="card is-danger-border">
            <div class="card-content">
              ...
              <p class="content">
                Ada pertanyaan? Langsung chat saja. Tim KMJ siap membantu menjawab kebutuhan kamu.
              </p>
              <a href="https://wa.me/6282334729001?text=Halo%20saya%20ingin%20bertanya"
                class="button is-rounded is-custom">
                Chat via WhatsApp
              </a>
            </div>
          </div>
        ...
        <div class="column is-one-quarter">
          <div class="card is-danger-border">
            <div class="card-content">
              ...
              <p class="content">
                Ingin berbicara langsung melalui telepon? Hubungi kami di nomor berikut.
              </p>
              <a href="tel:082334729001" class="button is-rounded is-custom">
                Telepon Kami
              </a>
            </div>
          </div>
        ...
        <div class="column is-one-quarter">
          <div class="card is-danger-border">
            <div class="card-content">
              <p class="title is-5">Layanan KMJ Auto Finance</p>
              <p class="content">
                Untuk pertanyaan seputar pembiayaan dan akun kredit Anda: <br />
                Jam operasional: <br />
        ...
        <div class="column is-one-quarter">
          <div class="card is-danger-border">
            <div class="card-content">
              <p class="title is-5">Hubungi Kami di Media Sosial</p>
              <p class="content">
                Tim KMJ juga siap membantu dan merespons pertanyaan melalui akun media sosial resmi kami.
              </p>
    ...
    <div class="faq-question">
      <h1 class="faq-contact-title is-5 m">Pertanyaan Lainnya</h1>
      <div class="accordion" id="accordionExample">
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
              aria-expanded="true" aria-controls="collapseOne"> Apakah saya mendapatkan garansi jika membeli mobil bekas
              di KMJ?
              di sini</button>
          </h2>
          <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
            <div class="accordion-body">Tentu, kami memberikan garansi mesin untuk periode tertentu agar pembeli lebih
              tenang dan percaya dengan kualitas mobil yang kami tawarkan.</div>
          </div>
        </div>
        <div class="accordion-item">
          <h2 class="accordion-header">
          ...
          <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
            <div class="accordion-body">Ya, semua mobil bekas yang kami jual sudah melalui proses inspeksi menyeluruh
              mulai dari kondisi mesin, interior, eksterior, hingga kelengkapan dokumen.</div>
          </div>
        </div>
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
              data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Dimana alamat showroom
              KMJ ini</button>
          </h2>
          <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
            <div class="accordion-body">Showroom kami berlokasi di Jl. Raya Soekarno-Hatta No. 123, Jakarta (contoh,
              bisa diganti sesuai alamat asli). Lokasi mudah dijangkau dan tersedia area parkir luas.</div>
          </div>
        </div>
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
              data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">Jam berapa showroom
              buka?</button>
          </h2>
