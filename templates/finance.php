...
$tips = [
  [
    "judul" => "Pahami Kemampuan Finansialmu",
    "deskripsi" => "Sebelum mengajukan kredit, pastikan cicilan bulanan tidak melebihi 30% dari total pendapatan agar keuangan tetap aman.",
    "gambar" => "https://tse4.mm.bing.net/th/id/OIP.gK_u2qay0mFi44oecFpC7AHaE8?pid=Api"
  ],
  [
    "judul" => "Bandingkan Suku Bunga & Tenor Kredit",
    "deskripsi" => "Setiap lembaga pembiayaan menawarkan suku bunga dan tenor yang berbeda. Pilih kombinasi yang paling sesuai dengan kebutuhanmu.",
    "gambar" => "https://cdni.iconscout.com/illustration/premium/preview/interest-rates-increased-7708488-6214472.png?f=webp&h=700"
  ],
  [
    "judul" => "Siapkan Dokumen Sejak Awal",
    "deskripsi" => "KTP, slip gaji, dan data pekerjaan biasanya dibutuhkan. Menyiapkannya sejak awal akan mempercepat proses persetujuan kredit.",
    "gambar" => "https://assets-global.website-files.com/611ad2f8400b4945c9e6d773/64583e97be7e5cc8281f2d5a_tgmd_05-06-2023_submitting-files.jpg"
  ],
];
...
<body class="page-finance">
  ...
  <div id="howItWorks" class="tab-content active">
    ...
    <!-- Tips Kredit -->
    <section class="section">
      <h2 class="title is-4">Tips Cerdas Mengajukan Kredit Mobil</h2>
      <div class="columns">
      ...
      <div class="accordion custom-accordion" id="resourcesAccordion">
        ...
        <div class="accordion-item">
          ...
          <div id="office" class="accordion-collapse collapse" data-bs-parent="#resourcesAccordion">
            <div class="accordion-body">
              Untuk mengajukan kredit mobil, dokumen yang dibutuhkan umumnya meliputi:

              1. KTP pemohon & pasangan (jika sudah menikah)

              2. Kartu Keluarga

              3. Slip gaji / laporan penghasilan
        ...
        <div class="accordion-item">
          ...
          <div id="foundation" class="accordion-collapse collapse" data-bs-parent="#resourcesAccordion">
            <div class="accordion-body">
              Proses persetujuan biasanya memakan waktu 1–3 hari kerja, tergantung kelengkapan dokumen dan hasil survei.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
              ...
              Bagaimana Perhitungan Cicilan Kredit?
            </button>
          </h2>
          <div id="marketing" class="accordion-collapse collapse" data-bs-parent="#resourcesAccordion">
            <div class="accordion-body">
              ...
              3. Tenor (durasi kredit)

              4. Suku bunga pembiayaan
              Kamu dapat menggunakan kalkulator kredit KMJ untuk mendapatkan estimasi cicilan.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#news">
              Apakah perlu survei rumah untuk pengajuan kredit?
            </button>
          </h2>
          <div id="news" class="accordion-collapse collapse" data-bs-parent="#resourcesAccordion">
            <div class="accordion-body">
              Ya, sebagian besar leasing akan melakukan survei untuk memverifikasi data dan memastikan kemampuan
              pembayaran. Prosesnya singkat, biasanya kurang dari 30 menit.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
              data-bs-target="#supplied">
              Apakah cicilan dapat dilunasi lebih cepat?
            </button>
          </h2>
              ...
              <div class="control">
                <div class="select is-fullwidth">
                  <select id="leasing">
                    ...
                    <?php foreach ($finance as $f): ?>
                      <option value="<?= $f['nama']; ?>" data-bunga="<?= $f['bunga']; ?>">
                        <?= $f['nama']; ?> (<?= $f['bunga']; ?>% )
                      </option>
                    <?php endforeach; ?>
                  </select>
