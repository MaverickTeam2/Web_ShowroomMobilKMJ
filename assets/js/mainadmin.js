...
// =========================
// INISIALISASI FITUR CROPPER (KHUSUS SETTINGS)
// =========================
function initCropperFeature() {
  ...
  // Jika halaman bukan settings (elemen tidak ada), hentikan
  if (!uploadLogo || !cropModalEl || !imageToCrop || !previewImage) return;
  ...
  uploadLogo.addEventListener('change', (e) => {
    ...
    reader.onload = () => {
      ...
      // Pastikan modal muncul setelah gambar siap
      imageToCrop.onload = () => {
        cropModal.show();
